                    ...
                    <div class="col-lg-12 col-xl-7">
                        <div class="card">
                            <div class="card-body p-5">
                                <h2 class="text-bold text-primary">RECEIPT</h2>
                                ...
                                <div class="border-top border-gray-200 mt-4 py-4">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <p class="fs-sm">
                                                <a href="#!" class="text-purple"><span>{{ $pesanan->user->email }}</span>
                                                </a>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <table class="table border-bottom border-gray-200 mt-3">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class="fs-sm text-dark text-uppercase-bold-sm text-center align-middle">
                                                Qnty
                                            </th>
